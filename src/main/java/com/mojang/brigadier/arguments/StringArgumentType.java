...
public class StringArgumentType implements ArgumentType<String> {
    // PaperMC start - cache common argument types
    ...
    // PaperMC end - cache common argument types
    ...
    public static StringArgumentType word() {
        return WORD_ARGUMENT; // PaperMC - cache common argument types
    }

    public static StringArgumentType string() {
        return QUOTED_ARGUMENT; // PaperMC - cache common argument types
    }

    public static StringArgumentType greedyString() {
        return GREEDY_ARGUMENT; // PaperMC - cache common argument types
    }
