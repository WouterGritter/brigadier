...
public class BoolArgumentType implements ArgumentType<Boolean> {
    private static final BoolArgumentType INSTANCE = new BoolArgumentType(); // PaperMC - cache common argument types
    ...
    public static BoolArgumentType bool() {
        return INSTANCE; // PaperMC - cache common argument types
    }
